...
// Release signing is read from keystore.properties at the repo root (gitignored). Absent it
// (e.g. a fresh clone / CI without secrets), release builds stay unsigned.
